...
public class StockApiController implements StockApi {
    ...
    public ResponseEntity<List<Student>> getStock(@ApiParam(value = "ID of the quote to return",required=true) @PathVariable("quoteId") Long quoteId) {
    ...
    public ResponseEntity<Void> postStock(@ApiParam(value = "Student to add"  )  @Valid @RequestBody Student body) {
        String accept = request.getHeader("Accept");
        return new ResponseEntity<Void>(HttpStatus.NOT_IMPLEMENTED);
    }
